...
//  MovieBooking
//
//  Created by aykut ipek on 9.08.2023.
//
        ...
        NavigationView {
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    Text("in the Multiverse of Maddness")
                        .font(.title3)
                        .foregroundColor(.white)
                    
                    Text("Dr. Stephan Strange casts a forbidden spell that opens the doorway to the multiverse, including alternate versions of...")
                        .font(.subheadline)
                        .foregroundColor(.white)
                        .padding(30)
